...
public class WSServer extends WSGestalt {
	...
	private final ExecutorService myExecService;
	
	private boolean serviceStarted;
	
	private final WSDatabase myDatabase;
	private final WSLegacyLogListener myLogListener;
	private final WSConfiguration myConfiguration;
	private final WSServerConsole myServerCommand;
